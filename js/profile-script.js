// Obtener datos del perfil y mostrar en la página de perfil
window.onload = () => {
    displayProfileData();
    displayUserStories();
};
...
function displayProfileData() {
    ...
    // Obtener el último username o usar "Anónimo" si no existe
...
function deleteStory(index) {
    ...
    displayProfileData();    // Actualizar totales de publicaciones y likes
    displayUserStories();    // Actualizar lista de publicaciones
}
